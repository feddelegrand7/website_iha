...
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/IhaddadenFodil
- icon: google-scholar
  icon_pack: ai
...
I've also developed an R package called **ralger** that facilitates web scraping in R. The package is currently not available at CRAN but you can use it from Github : https://github.com/feddelegrand7/ralger
