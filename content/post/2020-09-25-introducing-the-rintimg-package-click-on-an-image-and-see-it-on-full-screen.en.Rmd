...
You can find an example below. The images were collected from [Unsplash](https://unsplash.com/s/photos/pineapple).
...
<center>
<img src = "https://images.unsplash.com/photo-1517260911058-0fcfd733702f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=813&q=80" width = "200px" height = "200px" class = "intensify">

<img src = "https://images.unsplash.com/photo-1515878459526-bfff71cfa6da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" width = "200px" height = "200px" class = "intensify">

<img src = "https://images.unsplash.com/photo-1501438400798-b40ff50396c8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" width = "200px" height = "200px">
</center>
